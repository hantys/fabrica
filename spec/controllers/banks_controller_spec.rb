  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {bank: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bank" do
        bank = Bank.create! valid_attributes
        put :update, params: {id: bank.to_param, bank: new_attributes}, session: valid_session
        bank.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        bank = Bank.create! valid_attributes
        put :update, params: {id: bank.to_param, bank: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
